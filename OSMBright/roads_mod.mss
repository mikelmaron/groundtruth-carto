...
@rdz14_maj: 4;   @rdz14_med: 2.5; @rdz14_min: 1.6; @rdz14_ped: 0.4;
@rdz15_maj: 6;   @rdz15_med: 4;   @rdz15_min: 2;   @rdz15_ped: 0.5;
@rdz16_maj: 8;   @rdz16_med: 6;   @rdz16_min: 3;   @rdz16_ped: 0.8;
...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=15] {
    ...
    [stylegroup='minorroad']{ line-width: 0; } //{ line-width: @rdz15_min + 2; }
    [stylegroup='service']  { line-width: 0; } //{ line-width: @rdz15_min / 3 + 2; }
  ...
  [zoom=16] {
    ...
    [stylegroup='minorroad']{ line-width: 0; } //{ line-width: @rdz16_min + 2; }
    [stylegroup='service']  { line-width: 0; } //{ line-width: @rdz16_min / 3 + 2; }
